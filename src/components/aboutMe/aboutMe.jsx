      ...
      <div className={style.flexContainer2}>
        ...
        <div className={style.description}>
          <p>
            ...
            passion for programming although I started studying web development
            in <a href="https://www.soyhenry.com/">Soy Henry</a> on 2022 ,
            always liked to program. I started in the programming world 10 years
            ago doing game servers.
          </p>
          <p>
